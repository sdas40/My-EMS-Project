...
public class UserInteraction {
	...
	public void AddEmployee(){
		emp_id++;
		System.out.println("enter the ehe department id");
		dID=sc.nextInt();
		System.out.println("enter the ehe project id");
		pid=sc.nextInt();
		do{
		...
		String deptid=Integer.toString(dID);
		String projid=Integer.toString(pid);
		System.out.println("choice of differnt department ");
	    dept=Dept.getdepartment();
	    System.out.println("choice of differnt Project");
	    proj=pj.getproject();
	    ...
	    employee.put(new Integer(11), deptid);
	    employee.put(new Integer(12), projid);
